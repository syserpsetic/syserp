                ...
                <div class="flex flex-1 items-center justify-center px-5 lg:justify-start">
                    ...
                    <div class="ml-5">
                        <div class="w-240 truncate text-lg font-medium sm:w-80 sm:whitespace-normal">
                            ...
                            <h1 class="text-5xl font-medium leading-none">ZONAS</h1>
                        </div>
                        <div class="text-slate-500">Pantalla de administración de zonas.</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="intro-y box mt-5 p-5">
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="intro-y col-span-6 lg:col-span-6 text-right">
                <div class="p-5">
                    @if(in_array('zeta_escribir_zonas', $scopes))
                        <x-base.button
                            class="mb-2 mr-1"
                            variant="primary"
                            id="btn_nueva_zona"
        ...
        <!-- BEGIN: Modal Content -->
        <x-base.dialog id="modal_nueva_zona">
            <x-base.dialog.panel>
                ...
                <x-base.dialog.description class="grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 sm:col-span-12">
                        ...
                        <x-base.form-input id="modal_input_nombre_zona" type="text" placeholder="Nombre de la zona" />
                    </div>
                    <div class="col-span-12 sm:col-span-12">
                        <x-base.form-label class="font-extrabold" for="modal_input_descripcion_zona">
                            Descripción
                        </x-base.form-label>
                        <x-base.form-input id="modal_input_descripcion_zona" type="text" placeholder="Describa la zona" />
                    </div>
...
@once
    @push('scripts')
        ...
        <script type="module">
            ...
            var url_guardar_zonas = "{{url('/configuracion/zonas/guardar')}}";
            var titleMsg = null;
            var textMsg = null;
            var typeMsg = null;
            var numerofila = null;
            ...
            $(document).ready(function() {
                ...
                $('#sdatatable tbody').on('click', '.editar', function() {
                    ...
                    id = data[0];
                    $("#modal_input_nombre_zona").val(data[1]);
                    $("#modal_input_descripcion_zona").val(data[2]);
            ...
            $("#modal_btn_guardar_zona").on("click", function () {
                nombre = $("#modal_input_nombre_zona").val();
                descripcion = $("#modal_input_descripcion_zona").val();
            ...
            function guardar_zonas() {
                accion_guardar = true;
                $.ajax({
                    type: "POST",
                    url: url_guardar_zonas,
                    data: {
                        'accion': accion,
                        'id': id,
                        'nombre': nombre,
